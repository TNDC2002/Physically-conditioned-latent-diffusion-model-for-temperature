...
sbatch \
    ...
    --wrap="cd $REPO_ROOT && \
            ...
            $REPO_ROOT/.venv/bin/python src/train.py experiment=downscaling_UNET_2mT paths.data_dir=$REPO_ROOT/LDM-downscaling/ callbacks.rich_progress_bar=null"
